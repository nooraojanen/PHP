 ...
 *
 * PHP-ohjelma, joka tarjoaa k�ytt�liittym�n tietyss� web-kansiossa sijaitsevien 
 * C++-ohjelmien syntaksin korostamiseen web-sivulla.
 *
 * K�ytt�� syntaksin korostukseen:
...
// jos seurattu linkkia ja kansiossa oleva tiedosto k�sill�:
...
if (!$found) echo "<li>T�ss� kansiossa ei ole tiedostoja p��tteill�: $file_extensions!\n";
echo "</ul>";
}
?> 