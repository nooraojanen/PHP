...
<form method="get" action="horoskooppi-form.php">
...
<form method="get" action="horoskooppi-save.php">

<textarea name="ennustus">
<?php include("$tahtimerkki"); ?>
</textarea>
<br>
<input type="submit" name="nappi" value="Tallenna">

<input type="hidden" name="tahtimerkki" value="<?php echo $tahtimerkki ?>">
